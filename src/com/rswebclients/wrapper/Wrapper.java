package com.rswebclients.wrapper;
...
public class Wrapper {
	...
	protected static Class<?> unwrap(Class<?> wrapped) {
	...
	public final <T> T setField(String name, Object setTo) {
		return setField(name, setTo, true);
	}

	public final <T> T setField(String name, Object setTo, boolean instance) {
		Object inst = instance ? this.instance : null;
		try {
			getField(name).set(inst, setTo);
